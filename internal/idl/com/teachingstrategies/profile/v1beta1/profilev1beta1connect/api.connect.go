...
import (
	...
	v1beta1 "github.com/kevinmichaelchen/temporal-saga-grpc/internal/idl/com/teachingstrategies/profile/v1beta1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	ProfileServiceName = "com.teachingstrategies.profile.v1beta1.ProfileService"
)

// ProfileServiceClient is a client for the com.teachingstrategies.profile.v1beta1.ProfileService
// service.
...
// com.teachingstrategies.profile.v1beta1.ProfileService service. By default, it uses the Connect
...
func NewProfileServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) ProfileServiceClient {
	...
	return &profileServiceClient{
		createProfile: connect_go.NewClient[v1beta1.CreateProfileRequest, v1beta1.CreateProfileResponse](
			httpClient,
			baseURL+"/com.teachingstrategies.profile.v1beta1.ProfileService/CreateProfile",
			opts...,
		),
	}
}
...
// CreateProfile calls com.teachingstrategies.profile.v1beta1.ProfileService.CreateProfile.
...
// com.teachingstrategies.profile.v1beta1.ProfileService service.
...
func NewProfileServiceHandler(svc ProfileServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/com.teachingstrategies.profile.v1beta1.ProfileService/CreateProfile", connect_go.NewUnaryHandler(
		"/com.teachingstrategies.profile.v1beta1.ProfileService/CreateProfile",
		svc.CreateProfile,
		opts...,
	))
	return "/com.teachingstrategies.profile.v1beta1.ProfileService/", mux
}
...
func (UnimplementedProfileServiceHandler) CreateProfile(context.Context, *connect_go.Request[v1beta1.CreateProfileRequest]) (*connect_go.Response[v1beta1.CreateProfileResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("com.teachingstrategies.profile.v1beta1.ProfileService.CreateProfile is not implemented"))
}
