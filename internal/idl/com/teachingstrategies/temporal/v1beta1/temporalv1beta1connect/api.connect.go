...
import (
	...
	v1beta1 "github.com/kevinmichaelchen/temporal-saga-grpc/internal/idl/com/teachingstrategies/temporal/v1beta1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	TemporalServiceName = "com.teachingstrategies.temporal.v1beta1.TemporalService"
)

// TemporalServiceClient is a client for the com.teachingstrategies.temporal.v1beta1.TemporalService
// service.
...
// NewTemporalServiceClient constructs a client for the
// com.teachingstrategies.temporal.v1beta1.TemporalService service. By default, it uses the Connect
...
func NewTemporalServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) TemporalServiceClient {
	...
	return &temporalServiceClient{
		createLicense: connect_go.NewClient[v1beta1.CreateLicenseRequest, v1beta1.CreateLicenseResponse](
			httpClient,
			baseURL+"/com.teachingstrategies.temporal.v1beta1.TemporalService/CreateLicense",
			opts...,
		),
	}
}
...
// CreateLicense calls com.teachingstrategies.temporal.v1beta1.TemporalService.CreateLicense.
...
// TemporalServiceHandler is an implementation of the
// com.teachingstrategies.temporal.v1beta1.TemporalService service.
...
func NewTemporalServiceHandler(svc TemporalServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/com.teachingstrategies.temporal.v1beta1.TemporalService/CreateLicense", connect_go.NewUnaryHandler(
		"/com.teachingstrategies.temporal.v1beta1.TemporalService/CreateLicense",
		svc.CreateLicense,
		opts...,
	))
	return "/com.teachingstrategies.temporal.v1beta1.TemporalService/", mux
}
...
func (UnimplementedTemporalServiceHandler) CreateLicense(context.Context, *connect_go.Request[v1beta1.CreateLicenseRequest]) (*connect_go.Response[v1beta1.CreateLicenseResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("com.teachingstrategies.temporal.v1beta1.TemporalService.CreateLicense is not implemented"))
}
